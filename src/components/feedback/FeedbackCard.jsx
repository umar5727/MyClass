...
const FeedbackCard = ({ className = '', ...props }) => {
  return (
    <div
      className={`flex flex-col gap-2  justify-center items-center px-4 py-8 bg-white dark:bg-card-dark-bg dark:text-white rounded-lg ${className}`}
      {...props}
    >
