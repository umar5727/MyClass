  ...
  return (
    <section className="mt-10 py-20 relative before:block before:absolute before:bg-primary-light before:left-2/4 before:-translate-x-2/4 before:w-screen before:h-full before:-z-10 before:content-[''] before:top-0  ">
      <div className="flex flex-col lg:flex-row ">
        <div
          className="flex justify-center items-center  gap-2 flex-col my-4 order-1 text-center lg:order-2 lg:text-left lg:items-start lg:w-2/5 p-4 lg:gap-4"
          data-aos='fade-left'
        >
        ...
        <div className="grid gap-5 md:grid-cols-2 order-2   lg:order-1 lg:w-3/5  lg:flex lg:flex-wrap  lg:gap-10">
          ...
          <FeedbackCard
            className="shadow-custom lg:relative lg:top-28 lg:w-7/12 "
            data-aos='fade-right'
          />
          <FeedbackCard
          ...
          {/* </div> */}
          <div
            className="hidden lg:block lg:relative lg:w-7/12 h-fit lg:top-28 "
            data-aos='fade-right'
          >
