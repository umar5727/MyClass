                    ...
                    <div className="flex flex-col gap-[10px] p-5 bg-primary-light rounded-md">
                        {fields.map((field, index) => (
                            <NavLink
                                ...
                                to={field.slug}
                                className={({ isActive }) => `${isActive ? "bg-primary text-white" : ""} flex gap-2 items-center py-2 px-4 transition hover:scale-105 duration-500 text-primary hover:text-white hover:bg-primary rounded-md dark:text-white `}
                                key={index}
                            >
                        ...
                        <Button
                            className={` flex gap-2 items-center py-2 !px-4 !transition hover:scale-105  duration-500 text-primary hover:text-white hover:bg-primary rounded-md dark:text-white outline-none border-none !justify-start`}
