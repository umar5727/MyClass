...
const WelcomeContent = ({ fullName }) => {
  ...
  return (
    <div className="lg:w-3/5 py-8  flex flex-col gap-8 justify-center items-center text-center lg:text-left lg:items-start md:py-0 relative">
      ...
      {/* bg image ends  */}
      <h1
        className="text-4xl md:text-5xl font-bold  text-primary-text-heading dark:text-white tracking-tight"
        data-aos='fade-right'
      >
        Welcome back, <strong className="md:text-6xl text-primary capitalize">{fullName.split(' ')[0]}!</strong><br /> Pick up where you left off.
      </h1>
      <p
