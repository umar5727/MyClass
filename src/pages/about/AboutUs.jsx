...
<article>
  <div className="lg:w-4/6">
        ...
        <h3 className="text-2xl md:text-3xl font-bold  text-primary-text-heading dark:text-white mb-2 mt-5">About MYClass</h3>
        <p className="text-base font-medium md:text-base  text-primary-text-normal dark:text-primary-text-normal-dark">How promotion excellent curiosity yet attempted happiness Gay prosperous impression had conviction For every delay death ask to style Me mean able my by in they Extremity now strangers contained.</p>
  </div>
